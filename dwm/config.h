...
static const char selbordercolor[]  = "#445F8E";
static const char selbgcolor[]      = "#445F8E";
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-i", "-l", "10", "-fn", font, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, "-p", "λ", NULL };
